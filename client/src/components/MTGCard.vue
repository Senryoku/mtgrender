			...
			>
				...
				<g stroke="black" stroke-width="0.06">
					...
					<path
						id="top-front"
						class="lighter-left-color"
						d="M 4.452 0.823 C 4.471 0.865 4.49 0.888 4.529 0.896 H 5.243 C 5.297 0.896 5.335 0.884 5.384 0.846 L 6.477 -0.087 H 6.003 L 5.188 0.657 C 5.113 0.722 5.022 0.781 4.932 0.817 H 4.452 Z"
					/>
					<path
						id="top-front"
						class="lighter-right-color"
