 ...
 *
 * Displays the complex SVG decorative frame for Mystical Archive cards
 * from Strixhaven. This includes:
 * - Noise/texture filters
 * - Ornamental decorations
 * - Color-specific gradients and features
 * - Gold accents and geometric patterns
 *
...
<style scoped>
/* Archive frame SVG color classes will be styled dynamically via parent CSS */
/* Classes used: .background-color, .background-feature, .gold, .primary-color,
   .primary-left-color, .primary-right-color, .lighter-color, .lighter-left-color,
   .lighter-right-color, .darker-color, .top-feature */
</style>
